...
![In Mapillary erfasst Bildsequenzen](/images/blog/walkie/bildsequenzen_freiburg.webp "Mapillary Straßenraumaufnahmen")_Abbildung 1: Erfasste Bildsequenzen im Rahmen des WALKIE Projektes_
...
Weitere Informationen zum Walkability Index finden Sie [hier](/docs/walkability_index/ "Docs: Walkability Index").
...
Das Team steht derzeit weiterhin mit dem DIGIT Freiburg im Kontakt, um - über das WALKIE Projekt hinaus - mögliche Einsatzfelder von GOAT zu untersuchen und die Anforderungen an das Tool zu definieren.

![BW Ministerium für Verkehr & MobiDataBW](/images/blog/hackathon/hackathon.webp "BW Ministerium für Verkehr & MobiDataBW")