...
1. You can add a WMS layer by using your own url. Paste the GetCapabilitiesURL for your layer in the field "source url" and click "add". A source URL for Freiburg is utilized in this illustration.
