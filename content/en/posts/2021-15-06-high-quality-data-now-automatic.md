...
1. [_Images API_](https://www.mapillary.com/developer/api-documentation/#images)_:_ it returns the images from a spatial parameter (within a delimited square or a point with a radius).
2. [_Object detections API_](https://help.mapillary.com/hc/en-us/articles/115000967191-Object-detections)_:_ it is a way to query by the content of the images.
3. [_Map Features API_](https://www.mapillary.com/developer/api-documentation/#map-features)_:_ returns locations of objects as point features on the map extracted from multiple images.
